#include <stdio.h>
#include <math.h>                                       //เรียกใช้คำสั่งคณิตศาสตร์เพื่อใช้ฟังก์ชัน fmod

int main(){
    double x=20.0;                                      //เก็บค่าตัวแปร
    double a=10.0;                                      //เก็บค่าตัวแปร
...
// ค่าที่แสดงผล: x=0.5500, total=140.00, score=45.00